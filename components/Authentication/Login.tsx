...
export const Login = ({onChange, onLogIn}: any) => {
    ...
    return (
        <SafeAreaView style={{backgroundColor: colors.BACKGROUND_COLOR_DARK, flex: 1}}>
            ...
            <View style={styles.container}>
                ...
                <Pressable 
                    ...
                    style={styles.submit}
                >
                    <Text style={[styles.submitText, userInput.email.length > 0 ? null : styles.inactive]}>Login</Text>
                </Pressable>
                <Pressable
